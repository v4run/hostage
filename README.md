...
- **Conflict detection** — if `/etc/hosts` is modified externally while `hostage` is open, the write is aborted and a split-pane scratch view shows the pre-reload buffer so you can reconcile changes manually
